...
describe('localStorage utilities', () => {
  ...
  describe('saveSaveConfig', () => {
    ...
    it('merges with existing configs', () => {
      ...
      localStorageMock.setItem(STORAGE_KEY, JSON.stringify({ wf_existing: existingConfig }));
  ...
  describe('loadWorkflowCostData', () => {
    ...
    it('returns cost data when found', () => {
      ...
      localStorageMock.setItem(COST_DATA_STORAGE_KEY, JSON.stringify({ wf_123: costData }));
  ...
  describe('loadGenerateImageDefaults', () => {
    ...
    it('returns stored settings when data exists', () => {
      ...
      localStorageMock.setItem(GENERATE_IMAGE_DEFAULTS_KEY, JSON.stringify(customSettings));
  ...
  describe('saveGenerateImageDefaults', () => {
    it('merges partial settings with existing', () => {
      ...
      localStorageMock.setItem(GENERATE_IMAGE_DEFAULTS_KEY, JSON.stringify(existing));
  ...
  describe('getProviderSettings', () => {
    ...
    it('merges with defaults for new providers', () => {
      ...
      localStorageMock.setItem(PROVIDER_SETTINGS_KEY, JSON.stringify(oldSettings));
