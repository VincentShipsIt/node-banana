...
export const useToast = create<ToastState>((set) => ({
  ...
  persistent: false,
  details: null,
  show: (message, type = 'info', persistent = false, details = null) =>
    set({ message, type, persistent, details }),
...
export function Toast() {
  ...
  return (
    <div className="fixed top-6 right-6 z-[200] animate-in fade-in slide-in-from-top-4 duration-300 max-w-md">
      <div className={`flex flex-col rounded-lg border shadow-xl ${typeStyles[type]}`}>
