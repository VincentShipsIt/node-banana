...
vi.mock('@/lib/quickstart/templates', () => {
  ...
  return {
    ...
    getPresetTemplate: (id: string) =>
      id === 'product-shot' ? { ...template, id: `workflow-${Date.now()}` } : null,
...
describe('WelcomeModal', () => {
  ...
  describe('Basic Rendering', () => {
    it('should render welcome modal with initial view by default', () => {
      render(<WelcomeModal onWorkflowGenerated={mockOnWorkflowGenerated} onClose={mockOnClose} />);
    ...
    it('should render modal overlay with backdrop', () => {
      const { container } = render(
        <WelcomeModal onWorkflowGenerated={mockOnWorkflowGenerated} onClose={mockOnClose} />
      );
  ...
  describe('File Loading', () => {
    ...
    it('should call onWorkflowGenerated when valid workflow file is loaded', async () => {
      ...
      const mockFileReader = {
        readAsText: vi.fn(function (this: {
