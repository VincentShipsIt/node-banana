...
describe('QuickstartTemplatesView', () => {
  ...
  describe('Basic Rendering', () => {
    it('should render header with title', async () => {
      render(
        <QuickstartTemplatesView onBack={mockOnBack} onWorkflowSelected={mockOnWorkflowSelected} />
      );
  ...
  describe('Preset Templates', () => {
    ...
    it('should disable all buttons while loading', async () => {
      ...
      const templateButtons = allButtons.filter((btn) => !btn.textContent?.includes('Back'));
