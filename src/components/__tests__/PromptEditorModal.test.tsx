...
describe('PromptEditorModal', () => {
  ...
  describe('Visibility', () => {
    it('should not render when isOpen is false', () => {
      render(
        <PromptEditorModal isOpen={false} initialPrompt="" onSubmit={vi.fn()} onClose={vi.fn()} />
      );
    ...
    it('should render with title when isOpen is true', () => {
      render(
        <PromptEditorModal isOpen={true} initialPrompt="" onSubmit={vi.fn()} onClose={vi.fn()} />
      );
  ...
  describe('Unsaved Changes Confirmation Dialog', () => {
    ...
    it('should dismiss confirmation dialog when clicking outside of it', async () => {
      ...
      const confirmationBackdrop = container.querySelector(
  ...
  describe('Font Size', () => {
    ...
    it('should save font size to localStorage when changed', () => {
      ...
      expect(mockLocalStorage.setItem).toHaveBeenCalledWith('prompt-editor-font-size', '20');
    });
