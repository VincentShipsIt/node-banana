...
describe('SplitGridSettingsModal', () => {
  ...
  describe('Default Prompt', () => {
    ...
    it('should display initial default prompt value', () => {
      ...
      render(<SplitGridSettingsModal nodeId="test-node" nodeData={nodeData} onClose={vi.fn()} />);
  ...
  describe('Create Button', () => {
    ...
    it('should update Create button text when target count changes', () => {
      ...
      // Click on 9
      const buttons = screen.getAllByRole('button');
      const nineButton = buttons.find(
        (btn) => btn.textContent?.includes('9') && !btn.textContent?.includes('Create')
      );
      fireEvent.click(nineButton!);
