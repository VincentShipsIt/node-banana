...
describe('CostDialog', () => {
  ...
  describe('Basic Rendering', () => {
    it('should render dialog with title', () => {
      render(
        <CostDialog predictedCost={createPredictedCost()} incurredCost={0} onClose={vi.fn()} />
      );
  ...
  describe('Cost Display', () => {
    ...
    it('should display formatted incurred cost', () => {
      render(
        <CostDialog predictedCost={createPredictedCost()} incurredCost={2.5} onClose={vi.fn()} />
      );
  ...
  describe('Reset Costs Button', () => {
    ...
    it('should show reset button when incurredCost is greater than 0', () => {
      render(
        <CostDialog predictedCost={createPredictedCost()} incurredCost={1.0} onClose={vi.fn()} />
      );
  ...
  describe('Close Behavior', () => {
    it('should call onClose when close button is clicked', () => {
      ...
      const { container } = render(
        <CostDialog predictedCost={createPredictedCost()} incurredCost={0} onClose={onClose} />
      );
