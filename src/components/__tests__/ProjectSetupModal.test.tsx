...
describe('ProjectSetupModal', () => {
    ...
    mockFetch.mockImplementation((url: string) => {
      if (url === '/api/env-status') {
        return Promise.resolve({
          ok: true,
          json: () =>
            Promise.resolve({ gemini: false, openai: false, replicate: false, fal: false }),
        });
      }
  ...
  describe('Visibility', () => {
    it('should not render when isOpen is false', () => {
      render(<ProjectSetupModal isOpen={false} onClose={vi.fn()} onSave={vi.fn()} mode="new" />);
    ...
    it("should render with 'New Project' title when mode is 'new'", () => {
      render(<ProjectSetupModal isOpen={true} onClose={vi.fn()} onSave={vi.fn()} mode="new" />);
    ...
    it("should render with 'Project Settings' title when mode is 'settings'", () => {
      render(
        <ProjectSetupModal isOpen={true} onClose={vi.fn()} onSave={vi.fn()} mode="settings" />
      );
  ...
  describe('Form Validation', () => {
    it('should show error when project name is empty', async () => {
      ...
      render(<ProjectSetupModal isOpen={true} onClose={vi.fn()} onSave={onSave} mode="new" />);
  ...
  describe('Cancel Button', () => {
    it('should call onClose when Cancel is clicked', () => {
      ...
      render(<ProjectSetupModal isOpen={true} onClose={onClose} onSave={vi.fn()} mode="new" />);
  ...
  describe('Keyboard Shortcuts', () => {
    it('should close modal when Escape is pressed', () => {
      ...
      const { container } = render(
        <ProjectSetupModal isOpen={true} onClose={onClose} onSave={vi.fn()} mode="new" />
      );
    ...
    it('should submit form when Enter is pressed', async () => {
      ...
      const { container } = render(
        <ProjectSetupModal isOpen={true} onClose={vi.fn()} onSave={onSave} mode="new" />
      );
  ...
  describe('Providers Tab', () => {
      ...
      mockFetch.mockImplementation((url: string) => {
        if (url === '/api/env-status') {
          return Promise.resolve({
            ok: true,
            json: () =>
              Promise.resolve({ gemini: true, openai: false, replicate: false, fal: false }),
          });
        }
        return Promise.resolve({ ok: true, json: () => Promise.resolve({ success: true }) });
      });
    ...
    it('should call onClose when Save is clicked on Providers tab', async () => {
      ...
      render(
        <ProjectSetupModal isOpen={true} onClose={onClose} onSave={vi.fn()} mode="settings" />
      );
