...
import type { TemplateCategory } from '@/types/quickstart';
  ...
  return (
    <div
      className={`
        ...
        ${isLoading ? 'bg-blue-600/20 border-blue-500/50' : 'bg-neutral-900/50 border-neutral-700'}
    ...
    >
      ...
      <div
        className={`
          ...
          ${isLoading ? 'bg-blue-500/20' : 'bg-neutral-800'}
        `}
      >
        {previewImage ? (
          <>
