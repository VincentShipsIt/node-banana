...
import type { CommunityWorkflowMeta, TemplateCategory, TemplateMetadata } from '@/types/quickstart';
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="flex-shrink-0 px-6 py-4 border-b border-neutral-700 flex items-center gap-4">
        ...
        <h2 className="text-lg font-semibold text-neutral-100">Template Explorer</h2>
      </div>
        ...
        <div className="flex-1 min-h-0 overflow-y-auto overscroll-contain p-6 space-y-6">
          ...
          {hasNoResults && hasActiveFilters && (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-xs text-neutral-500 mb-4">Try adjusting your search or filters</p>
              <button
                onClick={clearFilters}
          ...
          {/* Divider */}
          {filteredPresets.length > 0 &&
            (filteredCommunity.length > 0 || (isLoadingList && categoryFilter !== 'community')) && (
                ...
                <div className="grid grid-cols-2 gap-4">
                  {filteredCommunity.map((workflow) => (
                    ...
                    >
                      ...
                      {/* Name */}
                      <h3 className="text-sm font-medium text-neutral-200 mb-1">{workflow.name}</h3>

                      {/* Author */}
                      <p className="text-xs text-purple-400/80">@{workflow.author}</p>
