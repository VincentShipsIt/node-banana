  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-4 border-b border-neutral-700 flex items-center gap-4">
        ...
        <h2 className="text-lg font-semibold text-neutral-100">Prompt a Workflow</h2>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <div className="space-y-2">
          <label className="text-xs font-medium text-neutral-400">Describe your workflow</label>
          <textarea
            value={description}
            onChange={(e) => {
          ...
          <p className="text-xs text-neutral-400">
            Describe what you want your workflow to accomplish. Be specific about inputs, outputs,
